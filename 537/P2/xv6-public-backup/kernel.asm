...
80100b32:	75 d2                	jne    80100b06 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100b34:	e8 77 63 00 00       	call   80106eb0 <setupkvm>
...
80100ba3:	e8 28 61 00 00       	call   80106cd0 <allocuvm>
...
80100bd9:	e8 02 60 00 00       	call   80106be0 <loaduvm>
...
80100c1b:	e8 10 62 00 00       	call   80106e30 <freevm>
  if(ip){
...
80100c81:	31 ff                	xor    %edi,%edi
  clearpteu(pgdir, (char*)(sz - 2*PGSIZE));
80100c83:	e8 c8 62 00 00       	call   80106f50 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100d11:	e8 1a 61 00 00       	call   80106e30 <freevm>
...
80100dcd:	e8 7e 5c 00 00       	call   80106a50 <switchuvm>
  freevm(oldpgdir);
80100dd2:	89 3c 24             	mov    %edi,(%esp)
80100dd5:	e8 56 60 00 00       	call   80106e30 <freevm>
  return 0;
...
80102088:	68 3e 79 10 80       	push   $0x8010793e
...
80103022:	e8 29 29 00 00       	call   80105950 <idtinit>
...
80103043:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80103046:	e8 f5 39 00 00       	call   80106a40 <switchkvm>
  seginit();
...
80103081:	e8 aa 3e 00 00       	call   80106f30 <kvmalloc>
...
801030a4:	e8 97 2b 00 00       	call   80105c40 <uartinit>
  pinit();         // process table
801030a9:	e8 22 08 00 00       	call   801038d0 <pinit>
  tvinit();        // trap vectors
801030ae:	e8 1d 28 00 00       	call   801058d0 <tvinit>
  binit();         // buffer cache
...
80103824:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103827:	c7 40 14 c2 58 10 80 	movl   $0x801058c2,0x14(%eax)
  p->context = (struct context*)sp;
...
80103945:	68 24 78 10 80       	push   $0x80107824
...
801039b3:	e8 f8 34 00 00       	call   80106eb0 <setupkvm>
...
801039d1:	e8 8a 31 00 00       	call   80106b60 <inituvm>
...
80103abb:	e8 90 2f 00 00       	call   80106a50 <switchuvm>
  return 0;
...
80103b48:	e8 53 34 00 00       	call   80106fa0 <copyuvm>
...
80103c92:	e8 e4 0b 00 00       	call   8010487b <swtch>
      switchkvm();
80103c97:	e8 a4 2d 00 00       	call   80106a40 <switchkvm>
      c->proc = 0;
...
80103f89:	e8 a2 2e 00 00       	call   80106e30 <freevm>
        p->pid = 0;
...
801041fb:	68 5f 7b 10 80       	push   $0x80107b5f
...
80104228:	8b 14 85 4c 78 10 80 	mov    -0x7fef87b4(,%eax,4),%edx
      state = "???";
...
801042aa:	68 64 78 10 80       	push   $0x80107864
...
801044e5:	68 6f 78 10 80       	push   $0x8010786f
801044ea:	e8 91 be ff ff       	call   80100380 <panic>
    panic("popcli");
801044ef:	83 ec 0c             	sub    $0xc,%esp
801044f2:	68 86 78 10 80       	push   $0x80107886
...
8010455b:	68 8d 78 10 80       	push   $0x8010788d
...
80104650:	68 95 78 10 80       	push   $0x80107895
...
80104a7c:	8b 14 85 c0 78 10 80 	mov    -0x7fef8740(,%eax,4),%edx
...
80104aa8:	68 9d 78 10 80       	push   $0x8010789d
...
80104c04:	68 34 79 10 80       	push   $0x80107934
...
80104c1c:	68 33 79 10 80       	push   $0x80107933
...
80104c31:	68 27 79 10 80       	push   $0x80107927
...
80104c4f:	68 36 79 10 80       	push   $0x80107936
80104c54:	e8 27 b7 ff ff       	call   80100380 <panic>
    panic("create: ialloc");
80104c59:	83 ec 0c             	sub    $0xc,%esp
80104c5c:	68 18 79 10 80       	push   $0x80107918
...
80104d74:	53                   	push   %ebx
  if(argint(n, &fd) < 0)
80104d75:	8d 75 f4             	lea    -0xc(%ebp),%esi
{
...
80104d88:	0f 88 b2 00 00 00    	js     80104e40 <sys_write+0xd0>
  if(fd < 0 || fd >= NOFILE || (f=myproc()->ofile[fd]) == 0)
80104d8e:	83 7d f4 0f          	cmpl   $0xf,-0xc(%ebp)
80104d92:	0f 87 a8 00 00 00    	ja     80104e40 <sys_write+0xd0>
80104d98:	e8 d3 eb ff ff       	call   80103970 <myproc>
80104d9d:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104da0:	8b 5c 90 28          	mov    0x28(%eax,%edx,4),%ebx
80104da4:	85 db                	test   %ebx,%ebx
80104da6:	0f 84 94 00 00 00    	je     80104e40 <sys_write+0xd0>
  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80104dac:	83 ec 08             	sub    $0x8,%esp
80104daf:	8d 45 f0             	lea    -0x10(%ebp),%eax
80104db2:	50                   	push   %eax
80104db3:	6a 02                	push   $0x2
80104db5:	e8 66 fb ff ff       	call   80104920 <argint>
80104dba:	83 c4 10             	add    $0x10,%esp
80104dbd:	85 c0                	test   %eax,%eax
80104dbf:	78 7f                	js     80104e40 <sys_write+0xd0>
80104dc1:	83 ec 04             	sub    $0x4,%esp
80104dc4:	ff 75 f0             	push   -0x10(%ebp)
80104dc7:	56                   	push   %esi
80104dc8:	6a 01                	push   $0x1
80104dca:	e8 a1 fb ff ff       	call   80104970 <argptr>
80104dcf:	83 c4 10             	add    $0x10,%esp
80104dd2:	85 c0                	test   %eax,%eax
80104dd4:	78 6a                	js     80104e40 <sys_write+0xd0>
  if(!strncmp(myproc()->name, "cat", strlen("cat"))) {
80104dd6:	83 ec 0c             	sub    $0xc,%esp
80104dd9:	68 46 79 10 80       	push   $0x80107946
80104dde:	e8 7d fa ff ff       	call   80104860 <strlen>
80104de3:	89 c6                	mov    %eax,%esi
80104de5:	e8 86 eb ff ff       	call   80103970 <myproc>
80104dea:	83 c4 0c             	add    $0xc,%esp
80104ded:	83 c0 6c             	add    $0x6c,%eax
80104df0:	56                   	push   %esi
80104df1:	68 46 79 10 80       	push   $0x80107946
80104df6:	50                   	push   %eax
80104df7:	e8 74 f9 ff ff       	call   80104770 <strncmp>
80104dfc:	83 c4 10             	add    $0x10,%esp
80104dff:	85 c0                	test   %eax,%eax
80104e01:	74 1d                	je     80104e20 <sys_write+0xb0>
  return filewrite(f, p, n);
80104e03:	83 ec 04             	sub    $0x4,%esp
80104e06:	ff 75 f0             	push   -0x10(%ebp)
80104e09:	ff 75 f4             	push   -0xc(%ebp)
80104e0c:	53                   	push   %ebx
80104e0d:	e8 9e c2 ff ff       	call   801010b0 <filewrite>
80104e12:	83 c4 10             	add    $0x10,%esp
}
80104e15:	8d 65 f8             	lea    -0x8(%ebp),%esp
80104e18:	5b                   	pop    %ebx
80104e19:	5e                   	pop    %esi
80104e1a:	5d                   	pop    %ebp
80104e1b:	c3                   	ret    
...
80104e26:	0f be 00             	movsbl (%eax),%eax
80104e29:	50                   	push   %eax
80104e2a:	68 4a 79 10 80       	push   $0x8010794a
80104e2f:	e8 6c b8 ff ff       	call   801006a0 <cprintf>
80104e34:	83 c4 10             	add    $0x10,%esp
80104e37:	eb ca                	jmp    80104e03 <sys_write+0x93>
80104e39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    return -1;
80104e40:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104e45:	eb ce                	jmp    80104e15 <sys_write+0xa5>
...
80104e81:	74 25                	je     80104ea8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e83:	e8 e8 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80104ebe:	e8 5d fa ff ff       	call   80104920 <argint>
...
80104ed0:	e8 9b ea ff ff       	call   80103970 <myproc>
...
80104ee8:	e8 83 fa ff ff       	call   80104970 <argptr>
...
80104f2f:	e8 ac fa ff ff       	call   801049e0 <argstr>
...
80104f48:	e8 93 fa ff ff       	call   801049e0 <argstr>
...
8010507f:	e8 5c f9 ff ff       	call   801049e0 <argstr>
...
801050bd:	58                   	pop    %eax
801050be:	5a                   	pop    %edx
801050bf:	68 34 79 10 80       	push   $0x80107934
...
801050d8:	68 33 79 10 80       	push   $0x80107933
...
80105132:	e8 29 f5 ff ff       	call   80104660 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
...
801051b1:	e8 da c8 ff ff       	call   80101a90 <readi>
...
80105204:	e8 c7 c4 ff ff       	call   801016d0 <iupdate>
...
80105216:	e9 6b ff ff ff       	jmp    80105186 <sys_unlink+0x116>
    end_op();
8010521b:	e8 b0 db ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105292:	78 79                	js     8010530d <sys_open+0xad>
  ...
  begin_op();
80105294:	e8 c7 da ff ff       	call   80102d60 <begin_op>
...
801052d7:	74 23                	je     801052fc <sys_open+0x9c>
  struct proc *curproc = myproc();
801052d9:	e8 92 e6 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105327:	e8 a4 f7 ff ff       	call   80104ad0 <create>
    if(ip == 0){
...
801053b4:	e8 27 f6 ff ff       	call   801049e0 <argstr>
...
801053cf:	e8 fc f6 ff ff       	call   80104ad0 <create>
...
801053df:	e8 2c c6 ff ff       	call   80101a10 <iunlockput>
  end_op();
801053e4:	e8 e7 d9 ff ff       	call   80102dd0 <end_op>
  return 0;
...
801053ef:	c3                   	ret    
    end_op();
801053f0:	e8 db d9 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105429:	e8 f2 f4 ff ff       	call   80104920 <argint>
  if((argstr(0, &path)) < 0 ||
...
8010543e:	e8 dd f4 ff ff       	call   80104920 <argint>
     argint(1, &major) < 0 ||
...
8010545e:	e8 6d f6 ff ff       	call   80104ad0 <create>
     argint(2, &minor) < 0 ||
...
80105495:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
80105498:	e8 d3 e4 ff ff       	call   80103970 <myproc>
...
801054ad:	e8 2e f5 ff ff       	call   801049e0 <argstr>
...
801054ed:	e8 be c3 ff ff       	call   801018b0 <iput>
  end_op();
801054f2:	e8 d9 d8 ff ff       	call   80102dd0 <end_op>
  curproc->cwd = ip;
...
80105514:	e8 f7 c4 ff ff       	call   80101a10 <iunlockput>
    end_op();
80105519:	e8 b2 d8 ff ff       	call   80102dd0 <end_op>
    return -1;
...
80105555:	e8 86 f4 ff ff       	call   801049e0 <argstr>
...
80105571:	e8 aa f3 ff ff       	call   80104920 <argint>
...
80105590:	e8 cb f0 ff ff       	call   80104660 <memset>
...
801055ba:	e8 d1 f2 ff ff       	call   80104890 <fetchint>
...
801055d8:	e8 f3 f2 ff ff       	call   801048d0 <fetchstr>
...
80105658:	e8 d3 dd ff ff       	call   80103430 <pipealloc>
...
80105667:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80105669:	e8 02 e3 ff ff       	call   80103970 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
{
  return fork();
80105700:	e9 0b e4 ff ff       	jmp    80103b10 <fork>
...
8010573c:	e8 df f1 ff ff       	call   80104920 <argint>
...
80105773:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105776:	e8 f5 e1 ff ff       	call   80103970 <myproc>
...
801057a6:	e8 e5 e2 ff ff       	call   80103a90 <growproc>
...
801057f5:	e8 a6 ed ff ff       	call   801045a0 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057fa:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057fd:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  while(ticks - ticks0 < n){
...
80105818:	68 60 3c 11 80       	push   $0x80113c60
8010581d:	e8 1e e8 ff ff       	call   80104040 <sleep>
  while(ticks - ticks0 < n){
80105822:	a1 60 3c 11 80       	mov    0x80113c60,%eax
...
80105845:	e8 f6 ec ff ff       	call   80104540 <release>
  }
  release(&tickslock);
  return 0;
}
...
80105868:	e8 d3 ec ff ff       	call   80104540 <release>
  return 0;
...
80105884:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105887:	68 80 3c 11 80       	push   $0x80113c80
8010588c:	e8 0f ed ff ff       	call   801045a0 <acquire>
  xticks = ticks;
80105891:	8b 1d 60 3c 11 80    	mov    0x80113c60,%ebx
  release(&tickslock);
80105897:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
8010589e:	e8 9d ec ff ff       	call   80104540 <release>
  return xticks;
}
...
801058ab:	06                   	push   %es
  pushl %fs
801058ac:	0f a0                	push   %fs
  pushl %gs
801058ae:	0f a8                	push   %gs
  pushal
801058b0:	60                   	pusha  
  
  # Set up data segments.
  movw $(SEG_KDATA<<3), %ax
801058b1:	66 b8 10 00          	mov    $0x10,%ax
  movw %ax, %ds
801058b5:	8e d8                	mov    %eax,%ds
  movw %ax, %es
801058b7:	8e c0                	mov    %eax,%es

  # Call trap(tf), where tf=%esp
  pushl %esp
801058b9:	54                   	push   %esp
  call trap
801058ba:	e8 c1 00 00 00       	call   80105980 <trap>
  addl $4, %esp
801058bf:	83 c4 04             	add    $0x4,%esp
...
801058c2:	61                   	popa   
  popl %gs
801058c3:	0f a9                	pop    %gs
  popl %fs
801058c5:	0f a1                	pop    %fs
  popl %es
801058c7:	07                   	pop    %es
  popl %ds
801058c8:	1f                   	pop    %ds
  addl $0x8, %esp  # trapno and errcode
801058c9:	83 c4 08             	add    $0x8,%esp
  iret
801058cc:	cf                   	iret   
...
801058e7:	c7 04 c5 c2 3c 11 80 	movl   $0x8e000008,-0x7feec33e(,%eax,8)
801058ee:	08 00 00 8e 
801058f2:	66 89 14 c5 c0 3c 11 	mov    %dx,-0x7feec340(,%eax,8)
801058f9:	80 
801058fa:	c1 ea 10             	shr    $0x10,%edx
801058fd:	66 89 14 c5 c6 3c 11 	mov    %dx,-0x7feec33a(,%eax,8)
80105904:	80 
  for(i = 0; i < 256; i++)
...
80105917:	c7 05 c2 3e 11 80 08 	movl   $0xef000008,0x80113ec2
8010591e:	00 00 ef 
  initlock(&tickslock, "time");
80105921:	68 82 79 10 80       	push   $0x80107982
80105926:	68 80 3c 11 80       	push   $0x80113c80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010592b:	66 a3 c0 3e 11 80    	mov    %ax,0x80113ec0
80105931:	c1 e8 10             	shr    $0x10,%eax
80105934:	66 a3 c6 3e 11 80    	mov    %ax,0x80113ec6
  initlock(&tickslock, "time");
8010593a:	e8 91 ea ff ff       	call   801043d0 <initlock>
}
...
8010595b:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
8010595f:	b8 c0 3c 11 80       	mov    $0x80113cc0,%eax
...
80105992:	0f 84 68 01 00 00    	je     80105b00 <trap+0x180>
    if(myproc()->killed)
      exit();
    return;
  }
...
8010599e:	0f 87 8c 00 00 00    	ja     80105a30 <trap+0xb0>
801059a4:	ff 24 85 28 7a 10 80 	jmp    *-0x7fef85d8(,%eax,4)
...
801059af:	90                   	nop
  ...
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801059b0:	e8 8b c8 ff ff       	call   80102240 <ideintr>
    lapiceoi();
801059b5:	e8 56 cf ff ff       	call   80102910 <lapiceoi>
  }
...
801059c1:	74 1d                	je     801059e0 <trap+0x60>
801059c3:	e8 a8 df ff ff       	call   80103970 <myproc>
801059c8:	8b 50 24             	mov    0x24(%eax),%edx
801059cb:	85 d2                	test   %edx,%edx
801059cd:	74 11                	je     801059e0 <trap+0x60>
801059cf:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801059d3:	83 e0 03             	and    $0x3,%eax
801059d6:	66 83 f8 03          	cmp    $0x3,%ax
801059da:	0f 84 e8 01 00 00    	je     80105bc8 <trap+0x248>
    exit();
...
801059e7:	74 0f                	je     801059f8 <trap+0x78>
801059e9:	e8 82 df ff ff       	call   80103970 <myproc>
801059ee:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
801059f2:	0f 84 b8 00 00 00    	je     80105ab0 <trap+0x130>
...
801059ff:	74 1d                	je     80105a1e <trap+0x9e>
80105a01:	e8 6a df ff ff       	call   80103970 <myproc>
80105a06:	8b 40 24             	mov    0x24(%eax),%eax
80105a09:	85 c0                	test   %eax,%eax
80105a0b:	74 11                	je     80105a1e <trap+0x9e>
80105a0d:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
80105a11:	83 e0 03             	and    $0x3,%eax
80105a14:	66 83 f8 03          	cmp    $0x3,%ax
80105a18:	0f 84 0f 01 00 00    	je     80105b2d <trap+0x1ad>
    exit();
}
80105a1e:	8d 65 f4             	lea    -0xc(%ebp),%esp
80105a21:	5b                   	pop    %ebx
80105a22:	5e                   	pop    %esi
80105a23:	5f                   	pop    %edi
80105a24:	5d                   	pop    %ebp
...
80105a3a:	0f 84 a2 01 00 00    	je     80105be2 <trap+0x262>
80105a40:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
80105a44:	0f 84 98 01 00 00    	je     80105be2 <trap+0x262>
...
80105a50:	e8 fb de ff ff       	call   80103950 <cpuid>
...
80105a85:	68 e4 79 10 80       	push   $0x801079e4
80105a8a:	e8 11 ac ff ff       	call   801006a0 <cprintf>
    myproc()->killed = 1;
80105a8f:	83 c4 20             	add    $0x20,%esp
80105a92:	e8 d9 de ff ff       	call   80103970 <myproc>
80105a97:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105a9e:	e8 cd de ff ff       	call   80103970 <myproc>
80105aa3:	85 c0                	test   %eax,%eax
80105aa5:	0f 85 18 ff ff ff    	jne    801059c3 <trap+0x43>
80105aab:	e9 30 ff ff ff       	jmp    801059e0 <trap+0x60>
  if(myproc() && myproc()->state == RUNNING &&
80105ab0:	83 7b 30 20          	cmpl   $0x20,0x30(%ebx)
80105ab4:	0f 85 3e ff ff ff    	jne    801059f8 <trap+0x78>
    yield();
80105aba:	e8 31 e5 ff ff       	call   80103ff0 <yield>
80105abf:	e9 34 ff ff ff       	jmp    801059f8 <trap+0x78>
...
80105acf:	e8 7c de ff ff       	call   80103950 <cpuid>
80105ad4:	57                   	push   %edi
80105ad5:	56                   	push   %esi
80105ad6:	50                   	push   %eax
80105ad7:	68 8c 79 10 80       	push   $0x8010798c
80105adc:	e8 bf ab ff ff       	call   801006a0 <cprintf>
    lapiceoi();
80105ae1:	e8 2a ce ff ff       	call   80102910 <lapiceoi>
    break;
80105ae6:	83 c4 10             	add    $0x10,%esp
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105ae9:	e8 82 de ff ff       	call   80103970 <myproc>
80105aee:	85 c0                	test   %eax,%eax
80105af0:	0f 85 cd fe ff ff    	jne    801059c3 <trap+0x43>
80105af6:	e9 e5 fe ff ff       	jmp    801059e0 <trap+0x60>
...
80105b0a:	0f 85 c8 00 00 00    	jne    80105bd8 <trap+0x258>
    myproc()->tf = tf;
80105b10:	e8 5b de ff ff       	call   80103970 <myproc>
80105b15:	89 58 18             	mov    %ebx,0x18(%eax)
    syscall();
80105b18:	e8 43 ef ff ff       	call   80104a60 <syscall>
    if(myproc()->killed)
80105b1d:	e8 4e de ff ff       	call   80103970 <myproc>
80105b22:	8b 48 24             	mov    0x24(%eax),%ecx
80105b25:	85 c9                	test   %ecx,%ecx
80105b27:	0f 84 f1 fe ff ff    	je     80105a1e <trap+0x9e>
}
...
80105b33:	5d                   	pop    %ebp
      exit();
80105b34:	e9 57 e2 ff ff       	jmp    80103d90 <exit>
80105b39:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105b40:	e8 3b 02 00 00       	call   80105d80 <uartintr>
    lapiceoi();
80105b45:	e8 c6 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b4a:	e8 21 de ff ff       	call   80103970 <myproc>
80105b4f:	85 c0                	test   %eax,%eax
80105b51:	0f 85 6c fe ff ff    	jne    801059c3 <trap+0x43>
80105b57:	e9 84 fe ff ff       	jmp    801059e0 <trap+0x60>
80105b5c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105b60:	e8 6b cc ff ff       	call   801027d0 <kbdintr>
    lapiceoi();
80105b65:	e8 a6 cd ff ff       	call   80102910 <lapiceoi>
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105b6a:	e8 01 de ff ff       	call   80103970 <myproc>
80105b6f:	85 c0                	test   %eax,%eax
80105b71:	0f 85 4c fe ff ff    	jne    801059c3 <trap+0x43>
80105b77:	e9 64 fe ff ff       	jmp    801059e0 <trap+0x60>
80105b7c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    if(cpuid() == 0){
80105b80:	e8 cb dd ff ff       	call   80103950 <cpuid>
80105b85:	85 c0                	test   %eax,%eax
80105b87:	0f 85 28 fe ff ff    	jne    801059b5 <trap+0x35>
      acquire(&tickslock);
80105b8d:	83 ec 0c             	sub    $0xc,%esp
80105b90:	68 80 3c 11 80       	push   $0x80113c80
80105b95:	e8 06 ea ff ff       	call   801045a0 <acquire>
      wakeup(&ticks);
80105b9a:	c7 04 24 60 3c 11 80 	movl   $0x80113c60,(%esp)
      ticks++;
80105ba1:	83 05 60 3c 11 80 01 	addl   $0x1,0x80113c60
      wakeup(&ticks);
80105ba8:	e8 53 e5 ff ff       	call   80104100 <wakeup>
      release(&tickslock);
80105bad:	c7 04 24 80 3c 11 80 	movl   $0x80113c80,(%esp)
80105bb4:	e8 87 e9 ff ff       	call   80104540 <release>
80105bb9:	83 c4 10             	add    $0x10,%esp
    lapiceoi();
80105bbc:	e9 f4 fd ff ff       	jmp    801059b5 <trap+0x35>
80105bc1:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    exit();
80105bc8:	e8 c3 e1 ff ff       	call   80103d90 <exit>
80105bcd:	e9 0e fe ff ff       	jmp    801059e0 <trap+0x60>
80105bd2:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105bd8:	e8 b3 e1 ff ff       	call   80103d90 <exit>
80105bdd:	e9 2e ff ff ff       	jmp    80105b10 <trap+0x190>
80105be2:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105be5:	e8 66 dd ff ff       	call   80103950 <cpuid>
80105bea:	83 ec 0c             	sub    $0xc,%esp
80105bed:	56                   	push   %esi
80105bee:	57                   	push   %edi
80105bef:	50                   	push   %eax
80105bf0:	ff 73 30             	push   0x30(%ebx)
80105bf3:	68 b0 79 10 80       	push   $0x801079b0
80105bf8:	e8 a3 aa ff ff       	call   801006a0 <cprintf>
      panic("trap");
80105bfd:	83 c4 14             	add    $0x14,%esp
80105c00:	68 87 79 10 80       	push   $0x80107987
...
80105c97:	74 78                	je     80105d11 <uartinit+0xd1>
  uart = 1;
80105c99:	c7 05 c0 44 11 80 01 	movl   $0x1,0x801144c0
80105ca0:	00 00 00 
...
80105cac:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105caf:	bf a8 7a 10 80       	mov    $0x80107aa8,%edi
80105cb4:	be fd 03 00 00       	mov    $0x3fd,%esi
  ioapicenable(IRQ_COM1, 0);
80105cb9:	6a 00                	push   $0x0
80105cbb:	6a 04                	push   $0x4
80105cbd:	e8 be c7 ff ff       	call   80102480 <ioapicenable>
  for(p="xv6...\n"; *p; p++)
80105cc2:	c6 45 e7 78          	movb   $0x78,-0x19(%ebp)
  ioapicenable(IRQ_COM1, 0);
...
80105cd5:	bb 80 00 00 00       	mov    $0x80,%ebx
80105cda:	85 c0                	test   %eax,%eax
80105cdc:	75 14                	jne    80105cf2 <uartinit+0xb2>
80105cde:	eb 23                	jmp    80105d03 <uartinit+0xc3>
    microdelay(10);
...
80105cf0:	74 07                	je     80105cf9 <uartinit+0xb9>
80105cf2:	89 f2                	mov    %esi,%edx
80105cf4:	ec                   	in     (%dx),%al
80105cf5:	a8 20                	test   $0x20,%al
80105cf7:	74 e7                	je     80105ce0 <uartinit+0xa0>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105cf9:	0f b6 45 e7          	movzbl -0x19(%ebp),%eax
80105cfd:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d02:	ee                   	out    %al,(%dx)
  for(p="xv6...\n"; *p; p++)
80105d03:	0f b6 47 01          	movzbl 0x1(%edi),%eax
80105d07:	83 c7 01             	add    $0x1,%edi
80105d0a:	88 45 e7             	mov    %al,-0x19(%ebp)
80105d0d:	84 c0                	test   %al,%al
80105d0f:	75 bf                	jne    80105cd0 <uartinit+0x90>
}
...
80105d27:	74 47                	je     80105d70 <uartputc+0x50>
{
...
80105d33:	bb 80 00 00 00       	mov    $0x80,%ebx
80105d38:	eb 18                	jmp    80105d52 <uartputc+0x32>
...
80105d50:	74 07                	je     80105d59 <uartputc+0x39>
80105d52:	89 f2                	mov    %esi,%edx
80105d54:	ec                   	in     (%dx),%al
80105d55:	a8 20                	test   $0x20,%al
80105d57:	74 e7                	je     80105d40 <uartputc+0x20>
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80105d59:	8b 45 08             	mov    0x8(%ebp),%eax
80105d5c:	ba f8 03 00 00       	mov    $0x3f8,%edx
80105d61:	ee                   	out    %al,(%dx)
}
80105d62:	8d 65 f8             	lea    -0x8(%ebp),%esp
80105d65:	5b                   	pop    %ebx
80105d66:	5e                   	pop    %esi
80105d67:	5d                   	pop    %ebp
80105d68:	c3                   	ret    
...
80105d8b:	e8 f0 aa ff ff       	call   80100880 <consoleintr>
}
...
80105d97:	6a 00                	push   $0x0
  jmp alltraps
80105d99:	e9 0c fb ff ff       	jmp    801058aa <alltraps>
...
80105da0:	6a 01                	push   $0x1
  jmp alltraps
80105da2:	e9 03 fb ff ff       	jmp    801058aa <alltraps>
...
80105da9:	6a 02                	push   $0x2
  jmp alltraps
80105dab:	e9 fa fa ff ff       	jmp    801058aa <alltraps>
...
80105db2:	6a 03                	push   $0x3
  jmp alltraps
80105db4:	e9 f1 fa ff ff       	jmp    801058aa <alltraps>
...
80105dbb:	6a 04                	push   $0x4
  jmp alltraps
80105dbd:	e9 e8 fa ff ff       	jmp    801058aa <alltraps>
...
80105dc4:	6a 05                	push   $0x5
  jmp alltraps
80105dc6:	e9 df fa ff ff       	jmp    801058aa <alltraps>
...
80105dcd:	6a 06                	push   $0x6
  jmp alltraps
80105dcf:	e9 d6 fa ff ff       	jmp    801058aa <alltraps>
...
80105dd6:	6a 07                	push   $0x7
  jmp alltraps
80105dd8:	e9 cd fa ff ff       	jmp    801058aa <alltraps>
...
80105ddd:	6a 08                	push   $0x8
  jmp alltraps
80105ddf:	e9 c6 fa ff ff       	jmp    801058aa <alltraps>
...
80105de6:	6a 09                	push   $0x9
  jmp alltraps
80105de8:	e9 bd fa ff ff       	jmp    801058aa <alltraps>
...
80105ded:	6a 0a                	push   $0xa
  jmp alltraps
80105def:	e9 b6 fa ff ff       	jmp    801058aa <alltraps>
...
80105df4:	6a 0b                	push   $0xb
  jmp alltraps
80105df6:	e9 af fa ff ff       	jmp    801058aa <alltraps>
...
80105dfb:	6a 0c                	push   $0xc
  jmp alltraps
80105dfd:	e9 a8 fa ff ff       	jmp    801058aa <alltraps>
...
80105e02:	6a 0d                	push   $0xd
  jmp alltraps
80105e04:	e9 a1 fa ff ff       	jmp    801058aa <alltraps>
...
80105e09:	6a 0e                	push   $0xe
  jmp alltraps
80105e0b:	e9 9a fa ff ff       	jmp    801058aa <alltraps>
...
80105e12:	6a 0f                	push   $0xf
  jmp alltraps
80105e14:	e9 91 fa ff ff       	jmp    801058aa <alltraps>
...
80105e1b:	6a 10                	push   $0x10
  jmp alltraps
80105e1d:	e9 88 fa ff ff       	jmp    801058aa <alltraps>
...
80105e22:	6a 11                	push   $0x11
  jmp alltraps
80105e24:	e9 81 fa ff ff       	jmp    801058aa <alltraps>
...
80105e2b:	6a 12                	push   $0x12
  jmp alltraps
80105e2d:	e9 78 fa ff ff       	jmp    801058aa <alltraps>
...
80105e34:	6a 13                	push   $0x13
  jmp alltraps
80105e36:	e9 6f fa ff ff       	jmp    801058aa <alltraps>
...
80105e3d:	6a 14                	push   $0x14
  jmp alltraps
80105e3f:	e9 66 fa ff ff       	jmp    801058aa <alltraps>
...
80105e46:	6a 15                	push   $0x15
  jmp alltraps
80105e48:	e9 5d fa ff ff       	jmp    801058aa <alltraps>
...
80105e4f:	6a 16                	push   $0x16
  jmp alltraps
80105e51:	e9 54 fa ff ff       	jmp    801058aa <alltraps>
...
80105e58:	6a 17                	push   $0x17
  jmp alltraps
80105e5a:	e9 4b fa ff ff       	jmp    801058aa <alltraps>
...
80105e61:	6a 18                	push   $0x18
  jmp alltraps
80105e63:	e9 42 fa ff ff       	jmp    801058aa <alltraps>
...
80105e6a:	6a 19                	push   $0x19
  jmp alltraps
80105e6c:	e9 39 fa ff ff       	jmp    801058aa <alltraps>
...
80105e73:	6a 1a                	push   $0x1a
  jmp alltraps
80105e75:	e9 30 fa ff ff       	jmp    801058aa <alltraps>
...
80105e7c:	6a 1b                	push   $0x1b
  jmp alltraps
80105e7e:	e9 27 fa ff ff       	jmp    801058aa <alltraps>
...
80105e85:	6a 1c                	push   $0x1c
  jmp alltraps
80105e87:	e9 1e fa ff ff       	jmp    801058aa <alltraps>
...
80105e8e:	6a 1d                	push   $0x1d
  jmp alltraps
80105e90:	e9 15 fa ff ff       	jmp    801058aa <alltraps>
...
80105e97:	6a 1e                	push   $0x1e
  jmp alltraps
80105e99:	e9 0c fa ff ff       	jmp    801058aa <alltraps>
...
80105ea0:	6a 1f                	push   $0x1f
  jmp alltraps
80105ea2:	e9 03 fa ff ff       	jmp    801058aa <alltraps>
...
80105ea9:	6a 20                	push   $0x20
  jmp alltraps
80105eab:	e9 fa f9 ff ff       	jmp    801058aa <alltraps>
...
80105eb2:	6a 21                	push   $0x21
  jmp alltraps
80105eb4:	e9 f1 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ebb:	6a 22                	push   $0x22
  jmp alltraps
80105ebd:	e9 e8 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ec4:	6a 23                	push   $0x23
  jmp alltraps
80105ec6:	e9 df f9 ff ff       	jmp    801058aa <alltraps>
...
80105ecd:	6a 24                	push   $0x24
  jmp alltraps
80105ecf:	e9 d6 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ed6:	6a 25                	push   $0x25
  jmp alltraps
80105ed8:	e9 cd f9 ff ff       	jmp    801058aa <alltraps>
...
80105edf:	6a 26                	push   $0x26
  jmp alltraps
80105ee1:	e9 c4 f9 ff ff       	jmp    801058aa <alltraps>
...
80105ee8:	6a 27                	push   $0x27
  jmp alltraps
80105eea:	e9 bb f9 ff ff       	jmp    801058aa <alltraps>
...
80105ef1:	6a 28                	push   $0x28
  jmp alltraps
80105ef3:	e9 b2 f9 ff ff       	jmp    801058aa <alltraps>
...
80105efa:	6a 29                	push   $0x29
  jmp alltraps
80105efc:	e9 a9 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f03:	6a 2a                	push   $0x2a
  jmp alltraps
80105f05:	e9 a0 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f0c:	6a 2b                	push   $0x2b
  jmp alltraps
80105f0e:	e9 97 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f15:	6a 2c                	push   $0x2c
  jmp alltraps
80105f17:	e9 8e f9 ff ff       	jmp    801058aa <alltraps>
...
80105f1e:	6a 2d                	push   $0x2d
  jmp alltraps
80105f20:	e9 85 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f27:	6a 2e                	push   $0x2e
  jmp alltraps
80105f29:	e9 7c f9 ff ff       	jmp    801058aa <alltraps>
...
80105f30:	6a 2f                	push   $0x2f
  jmp alltraps
80105f32:	e9 73 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f39:	6a 30                	push   $0x30
  jmp alltraps
80105f3b:	e9 6a f9 ff ff       	jmp    801058aa <alltraps>
...
80105f42:	6a 31                	push   $0x31
  jmp alltraps
80105f44:	e9 61 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f4b:	6a 32                	push   $0x32
  jmp alltraps
80105f4d:	e9 58 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f54:	6a 33                	push   $0x33
  jmp alltraps
80105f56:	e9 4f f9 ff ff       	jmp    801058aa <alltraps>
...
80105f5d:	6a 34                	push   $0x34
  jmp alltraps
80105f5f:	e9 46 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f66:	6a 35                	push   $0x35
  jmp alltraps
80105f68:	e9 3d f9 ff ff       	jmp    801058aa <alltraps>
...
80105f6f:	6a 36                	push   $0x36
  jmp alltraps
80105f71:	e9 34 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f78:	6a 37                	push   $0x37
  jmp alltraps
80105f7a:	e9 2b f9 ff ff       	jmp    801058aa <alltraps>
...
80105f81:	6a 38                	push   $0x38
  jmp alltraps
80105f83:	e9 22 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f8a:	6a 39                	push   $0x39
  jmp alltraps
80105f8c:	e9 19 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f93:	6a 3a                	push   $0x3a
  jmp alltraps
80105f95:	e9 10 f9 ff ff       	jmp    801058aa <alltraps>
...
80105f9c:	6a 3b                	push   $0x3b
  jmp alltraps
80105f9e:	e9 07 f9 ff ff       	jmp    801058aa <alltraps>
...
80105fa5:	6a 3c                	push   $0x3c
  jmp alltraps
80105fa7:	e9 fe f8 ff ff       	jmp    801058aa <alltraps>
...
80105fae:	6a 3d                	push   $0x3d
  jmp alltraps
80105fb0:	e9 f5 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fb7:	6a 3e                	push   $0x3e
  jmp alltraps
80105fb9:	e9 ec f8 ff ff       	jmp    801058aa <alltraps>
...
80105fc0:	6a 3f                	push   $0x3f
  jmp alltraps
80105fc2:	e9 e3 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fc9:	6a 40                	push   $0x40
  jmp alltraps
80105fcb:	e9 da f8 ff ff       	jmp    801058aa <alltraps>
...
80105fd2:	6a 41                	push   $0x41
  jmp alltraps
80105fd4:	e9 d1 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fdb:	6a 42                	push   $0x42
  jmp alltraps
80105fdd:	e9 c8 f8 ff ff       	jmp    801058aa <alltraps>
...
80105fe4:	6a 43                	push   $0x43
  jmp alltraps
80105fe6:	e9 bf f8 ff ff       	jmp    801058aa <alltraps>
...
80105fed:	6a 44                	push   $0x44
  jmp alltraps
80105fef:	e9 b6 f8 ff ff       	jmp    801058aa <alltraps>
...
80105ff6:	6a 45                	push   $0x45
  jmp alltraps
80105ff8:	e9 ad f8 ff ff       	jmp    801058aa <alltraps>
...
80105fff:	6a 46                	push   $0x46
  jmp alltraps
80106001:	e9 a4 f8 ff ff       	jmp    801058aa <alltraps>
...
80106008:	6a 47                	push   $0x47
  jmp alltraps
8010600a:	e9 9b f8 ff ff       	jmp    801058aa <alltraps>
...
80106011:	6a 48                	push   $0x48
  jmp alltraps
80106013:	e9 92 f8 ff ff       	jmp    801058aa <alltraps>
...
8010601a:	6a 49                	push   $0x49
  jmp alltraps
8010601c:	e9 89 f8 ff ff       	jmp    801058aa <alltraps>
...
80106023:	6a 4a                	push   $0x4a
  jmp alltraps
80106025:	e9 80 f8 ff ff       	jmp    801058aa <alltraps>
...
8010602c:	6a 4b                	push   $0x4b
  jmp alltraps
8010602e:	e9 77 f8 ff ff       	jmp    801058aa <alltraps>
...
80106035:	6a 4c                	push   $0x4c
  jmp alltraps
80106037:	e9 6e f8 ff ff       	jmp    801058aa <alltraps>
...
8010603e:	6a 4d                	push   $0x4d
  jmp alltraps
80106040:	e9 65 f8 ff ff       	jmp    801058aa <alltraps>
...
80106047:	6a 4e                	push   $0x4e
  jmp alltraps
80106049:	e9 5c f8 ff ff       	jmp    801058aa <alltraps>
...
80106050:	6a 4f                	push   $0x4f
  jmp alltraps
80106052:	e9 53 f8 ff ff       	jmp    801058aa <alltraps>
...
80106059:	6a 50                	push   $0x50
  jmp alltraps
8010605b:	e9 4a f8 ff ff       	jmp    801058aa <alltraps>
...
80106062:	6a 51                	push   $0x51
  jmp alltraps
80106064:	e9 41 f8 ff ff       	jmp    801058aa <alltraps>
...
8010606b:	6a 52                	push   $0x52
  jmp alltraps
8010606d:	e9 38 f8 ff ff       	jmp    801058aa <alltraps>
...
80106074:	6a 53                	push   $0x53
  jmp alltraps
80106076:	e9 2f f8 ff ff       	jmp    801058aa <alltraps>
...
8010607d:	6a 54                	push   $0x54
  jmp alltraps
8010607f:	e9 26 f8 ff ff       	jmp    801058aa <alltraps>
...
80106086:	6a 55                	push   $0x55
  jmp alltraps
80106088:	e9 1d f8 ff ff       	jmp    801058aa <alltraps>
...
8010608f:	6a 56                	push   $0x56
  jmp alltraps
80106091:	e9 14 f8 ff ff       	jmp    801058aa <alltraps>
...
80106098:	6a 57                	push   $0x57
  jmp alltraps
8010609a:	e9 0b f8 ff ff       	jmp    801058aa <alltraps>
...
801060a1:	6a 58                	push   $0x58
  jmp alltraps
801060a3:	e9 02 f8 ff ff       	jmp    801058aa <alltraps>
...
801060aa:	6a 59                	push   $0x59
  jmp alltraps
801060ac:	e9 f9 f7 ff ff       	jmp    801058aa <alltraps>
...
801060b3:	6a 5a                	push   $0x5a
  jmp alltraps
801060b5:	e9 f0 f7 ff ff       	jmp    801058aa <alltraps>
...
801060bc:	6a 5b                	push   $0x5b
  jmp alltraps
801060be:	e9 e7 f7 ff ff       	jmp    801058aa <alltraps>
...
801060c5:	6a 5c                	push   $0x5c
  jmp alltraps
801060c7:	e9 de f7 ff ff       	jmp    801058aa <alltraps>
...
801060ce:	6a 5d                	push   $0x5d
  jmp alltraps
801060d0:	e9 d5 f7 ff ff       	jmp    801058aa <alltraps>
...
801060d7:	6a 5e                	push   $0x5e
  jmp alltraps
801060d9:	e9 cc f7 ff ff       	jmp    801058aa <alltraps>
...
801060e0:	6a 5f                	push   $0x5f
  jmp alltraps
801060e2:	e9 c3 f7 ff ff       	jmp    801058aa <alltraps>
...
801060e9:	6a 60                	push   $0x60
  jmp alltraps
801060eb:	e9 ba f7 ff ff       	jmp    801058aa <alltraps>
...
801060f2:	6a 61                	push   $0x61
  jmp alltraps
801060f4:	e9 b1 f7 ff ff       	jmp    801058aa <alltraps>
...
801060fb:	6a 62                	push   $0x62
  jmp alltraps
801060fd:	e9 a8 f7 ff ff       	jmp    801058aa <alltraps>
...
80106104:	6a 63                	push   $0x63
  jmp alltraps
80106106:	e9 9f f7 ff ff       	jmp    801058aa <alltraps>
...
8010610d:	6a 64                	push   $0x64
  jmp alltraps
8010610f:	e9 96 f7 ff ff       	jmp    801058aa <alltraps>
...
80106116:	6a 65                	push   $0x65
  jmp alltraps
80106118:	e9 8d f7 ff ff       	jmp    801058aa <alltraps>
...
8010611f:	6a 66                	push   $0x66
  jmp alltraps
80106121:	e9 84 f7 ff ff       	jmp    801058aa <alltraps>
...
80106128:	6a 67                	push   $0x67
  jmp alltraps
8010612a:	e9 7b f7 ff ff       	jmp    801058aa <alltraps>
...
80106131:	6a 68                	push   $0x68
  jmp alltraps
80106133:	e9 72 f7 ff ff       	jmp    801058aa <alltraps>
...
8010613a:	6a 69                	push   $0x69
  jmp alltraps
8010613c:	e9 69 f7 ff ff       	jmp    801058aa <alltraps>
...
80106143:	6a 6a                	push   $0x6a
  jmp alltraps
80106145:	e9 60 f7 ff ff       	jmp    801058aa <alltraps>
...
8010614c:	6a 6b                	push   $0x6b
  jmp alltraps
8010614e:	e9 57 f7 ff ff       	jmp    801058aa <alltraps>
...
80106155:	6a 6c                	push   $0x6c
  jmp alltraps
80106157:	e9 4e f7 ff ff       	jmp    801058aa <alltraps>
...
8010615e:	6a 6d                	push   $0x6d
  jmp alltraps
80106160:	e9 45 f7 ff ff       	jmp    801058aa <alltraps>
...
80106167:	6a 6e                	push   $0x6e
  jmp alltraps
80106169:	e9 3c f7 ff ff       	jmp    801058aa <alltraps>
...
80106170:	6a 6f                	push   $0x6f
  jmp alltraps
80106172:	e9 33 f7 ff ff       	jmp    801058aa <alltraps>
...
80106179:	6a 70                	push   $0x70
  jmp alltraps
8010617b:	e9 2a f7 ff ff       	jmp    801058aa <alltraps>
...
80106182:	6a 71                	push   $0x71
  jmp alltraps
80106184:	e9 21 f7 ff ff       	jmp    801058aa <alltraps>
...
8010618b:	6a 72                	push   $0x72
  jmp alltraps
8010618d:	e9 18 f7 ff ff       	jmp    801058aa <alltraps>
...
80106194:	6a 73                	push   $0x73
  jmp alltraps
80106196:	e9 0f f7 ff ff       	jmp    801058aa <alltraps>
...
8010619d:	6a 74                	push   $0x74
  jmp alltraps
8010619f:	e9 06 f7 ff ff       	jmp    801058aa <alltraps>
...
801061a6:	6a 75                	push   $0x75
  jmp alltraps
801061a8:	e9 fd f6 ff ff       	jmp    801058aa <alltraps>
...
801061af:	6a 76                	push   $0x76
  jmp alltraps
801061b1:	e9 f4 f6 ff ff       	jmp    801058aa <alltraps>
...
801061b8:	6a 77                	push   $0x77
  jmp alltraps
801061ba:	e9 eb f6 ff ff       	jmp    801058aa <alltraps>
...
801061c1:	6a 78                	push   $0x78
  jmp alltraps
801061c3:	e9 e2 f6 ff ff       	jmp    801058aa <alltraps>
...
801061ca:	6a 79                	push   $0x79
  jmp alltraps
801061cc:	e9 d9 f6 ff ff       	jmp    801058aa <alltraps>
...
801061d3:	6a 7a                	push   $0x7a
  jmp alltraps
801061d5:	e9 d0 f6 ff ff       	jmp    801058aa <alltraps>
...
801061dc:	6a 7b                	push   $0x7b
  jmp alltraps
801061de:	e9 c7 f6 ff ff       	jmp    801058aa <alltraps>
...
801061e5:	6a 7c                	push   $0x7c
  jmp alltraps
801061e7:	e9 be f6 ff ff       	jmp    801058aa <alltraps>
...
801061ee:	6a 7d                	push   $0x7d
  jmp alltraps
801061f0:	e9 b5 f6 ff ff       	jmp    801058aa <alltraps>
...
801061f7:	6a 7e                	push   $0x7e
  jmp alltraps
801061f9:	e9 ac f6 ff ff       	jmp    801058aa <alltraps>
...
80106200:	6a 7f                	push   $0x7f
  jmp alltraps
80106202:	e9 a3 f6 ff ff       	jmp    801058aa <alltraps>
...
80106209:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010620e:	e9 97 f6 ff ff       	jmp    801058aa <alltraps>
...
80106215:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010621a:	e9 8b f6 ff ff       	jmp    801058aa <alltraps>
...
80106221:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106226:	e9 7f f6 ff ff       	jmp    801058aa <alltraps>
...
8010622d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106232:	e9 73 f6 ff ff       	jmp    801058aa <alltraps>
...
80106239:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010623e:	e9 67 f6 ff ff       	jmp    801058aa <alltraps>
...
80106245:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010624a:	e9 5b f6 ff ff       	jmp    801058aa <alltraps>
...
80106251:	68 86 00 00 00       	push   $0x86
  jmp alltraps
80106256:	e9 4f f6 ff ff       	jmp    801058aa <alltraps>
...
8010625d:	68 87 00 00 00       	push   $0x87
  jmp alltraps
80106262:	e9 43 f6 ff ff       	jmp    801058aa <alltraps>
...
80106269:	68 88 00 00 00       	push   $0x88
  jmp alltraps
8010626e:	e9 37 f6 ff ff       	jmp    801058aa <alltraps>
...
80106275:	68 89 00 00 00       	push   $0x89
  jmp alltraps
8010627a:	e9 2b f6 ff ff       	jmp    801058aa <alltraps>
...
80106281:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
80106286:	e9 1f f6 ff ff       	jmp    801058aa <alltraps>
...
8010628d:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
80106292:	e9 13 f6 ff ff       	jmp    801058aa <alltraps>
...
80106299:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
8010629e:	e9 07 f6 ff ff       	jmp    801058aa <alltraps>
...
801062a5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062aa:	e9 fb f5 ff ff       	jmp    801058aa <alltraps>
...
801062b1:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
801062b6:	e9 ef f5 ff ff       	jmp    801058aa <alltraps>
...
801062bd:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
801062c2:	e9 e3 f5 ff ff       	jmp    801058aa <alltraps>
...
801062c9:	68 90 00 00 00       	push   $0x90
  jmp alltraps
801062ce:	e9 d7 f5 ff ff       	jmp    801058aa <alltraps>
...
801062d5:	68 91 00 00 00       	push   $0x91
  jmp alltraps
801062da:	e9 cb f5 ff ff       	jmp    801058aa <alltraps>
...
801062e1:	68 92 00 00 00       	push   $0x92
  jmp alltraps
801062e6:	e9 bf f5 ff ff       	jmp    801058aa <alltraps>
...
801062ed:	68 93 00 00 00       	push   $0x93
  jmp alltraps
801062f2:	e9 b3 f5 ff ff       	jmp    801058aa <alltraps>
...
801062f9:	68 94 00 00 00       	push   $0x94
  jmp alltraps
801062fe:	e9 a7 f5 ff ff       	jmp    801058aa <alltraps>
...
80106305:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010630a:	e9 9b f5 ff ff       	jmp    801058aa <alltraps>
...
80106311:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106316:	e9 8f f5 ff ff       	jmp    801058aa <alltraps>
...
8010631d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106322:	e9 83 f5 ff ff       	jmp    801058aa <alltraps>
...
80106329:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010632e:	e9 77 f5 ff ff       	jmp    801058aa <alltraps>
...
80106335:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010633a:	e9 6b f5 ff ff       	jmp    801058aa <alltraps>
...
80106341:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106346:	e9 5f f5 ff ff       	jmp    801058aa <alltraps>
...
8010634d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
80106352:	e9 53 f5 ff ff       	jmp    801058aa <alltraps>
...
80106359:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
8010635e:	e9 47 f5 ff ff       	jmp    801058aa <alltraps>
...
80106365:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
8010636a:	e9 3b f5 ff ff       	jmp    801058aa <alltraps>
...
80106371:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
80106376:	e9 2f f5 ff ff       	jmp    801058aa <alltraps>
...
8010637d:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
80106382:	e9 23 f5 ff ff       	jmp    801058aa <alltraps>
...
80106389:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
8010638e:	e9 17 f5 ff ff       	jmp    801058aa <alltraps>
...
80106395:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
8010639a:	e9 0b f5 ff ff       	jmp    801058aa <alltraps>
...
801063a1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063a6:	e9 ff f4 ff ff       	jmp    801058aa <alltraps>
...
801063ad:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
801063b2:	e9 f3 f4 ff ff       	jmp    801058aa <alltraps>
...
801063b9:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
801063be:	e9 e7 f4 ff ff       	jmp    801058aa <alltraps>
...
801063c5:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
801063ca:	e9 db f4 ff ff       	jmp    801058aa <alltraps>
...
801063d1:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
801063d6:	e9 cf f4 ff ff       	jmp    801058aa <alltraps>
...
801063dd:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
801063e2:	e9 c3 f4 ff ff       	jmp    801058aa <alltraps>
...
801063e9:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
801063ee:	e9 b7 f4 ff ff       	jmp    801058aa <alltraps>
...
801063f5:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
801063fa:	e9 ab f4 ff ff       	jmp    801058aa <alltraps>
...
80106401:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106406:	e9 9f f4 ff ff       	jmp    801058aa <alltraps>
...
8010640d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106412:	e9 93 f4 ff ff       	jmp    801058aa <alltraps>
...
80106419:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010641e:	e9 87 f4 ff ff       	jmp    801058aa <alltraps>
...
80106425:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010642a:	e9 7b f4 ff ff       	jmp    801058aa <alltraps>
...
80106431:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106436:	e9 6f f4 ff ff       	jmp    801058aa <alltraps>
...
8010643d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106442:	e9 63 f4 ff ff       	jmp    801058aa <alltraps>
...
80106449:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010644e:	e9 57 f4 ff ff       	jmp    801058aa <alltraps>
...
80106455:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
8010645a:	e9 4b f4 ff ff       	jmp    801058aa <alltraps>
...
80106461:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
80106466:	e9 3f f4 ff ff       	jmp    801058aa <alltraps>
...
8010646d:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
80106472:	e9 33 f4 ff ff       	jmp    801058aa <alltraps>
...
80106479:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
8010647e:	e9 27 f4 ff ff       	jmp    801058aa <alltraps>
...
80106485:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
8010648a:	e9 1b f4 ff ff       	jmp    801058aa <alltraps>
...
80106491:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
80106496:	e9 0f f4 ff ff       	jmp    801058aa <alltraps>
...
8010649d:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064a2:	e9 03 f4 ff ff       	jmp    801058aa <alltraps>
...
801064a9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064ae:	e9 f7 f3 ff ff       	jmp    801058aa <alltraps>
...
801064b5:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
801064ba:	e9 eb f3 ff ff       	jmp    801058aa <alltraps>
...
801064c1:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
801064c6:	e9 df f3 ff ff       	jmp    801058aa <alltraps>
...
801064cd:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
801064d2:	e9 d3 f3 ff ff       	jmp    801058aa <alltraps>
...
801064d9:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
801064de:	e9 c7 f3 ff ff       	jmp    801058aa <alltraps>
...
801064e5:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
801064ea:	e9 bb f3 ff ff       	jmp    801058aa <alltraps>
...
801064f1:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
801064f6:	e9 af f3 ff ff       	jmp    801058aa <alltraps>
...
801064fd:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106502:	e9 a3 f3 ff ff       	jmp    801058aa <alltraps>
...
80106509:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010650e:	e9 97 f3 ff ff       	jmp    801058aa <alltraps>
...
80106515:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010651a:	e9 8b f3 ff ff       	jmp    801058aa <alltraps>
...
80106521:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106526:	e9 7f f3 ff ff       	jmp    801058aa <alltraps>
...
8010652d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106532:	e9 73 f3 ff ff       	jmp    801058aa <alltraps>
...
80106539:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010653e:	e9 67 f3 ff ff       	jmp    801058aa <alltraps>
...
80106545:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010654a:	e9 5b f3 ff ff       	jmp    801058aa <alltraps>
...
80106551:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
80106556:	e9 4f f3 ff ff       	jmp    801058aa <alltraps>
...
8010655d:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
80106562:	e9 43 f3 ff ff       	jmp    801058aa <alltraps>
...
80106569:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
8010656e:	e9 37 f3 ff ff       	jmp    801058aa <alltraps>
...
80106575:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
8010657a:	e9 2b f3 ff ff       	jmp    801058aa <alltraps>
...
80106581:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
80106586:	e9 1f f3 ff ff       	jmp    801058aa <alltraps>
...
8010658d:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
80106592:	e9 13 f3 ff ff       	jmp    801058aa <alltraps>
...
80106599:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
8010659e:	e9 07 f3 ff ff       	jmp    801058aa <alltraps>
...
801065a5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065aa:	e9 fb f2 ff ff       	jmp    801058aa <alltraps>
...
801065b1:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
801065b6:	e9 ef f2 ff ff       	jmp    801058aa <alltraps>
...
801065bd:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
801065c2:	e9 e3 f2 ff ff       	jmp    801058aa <alltraps>
...
801065c9:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
801065ce:	e9 d7 f2 ff ff       	jmp    801058aa <alltraps>
...
801065d5:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
801065da:	e9 cb f2 ff ff       	jmp    801058aa <alltraps>
...
801065e1:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
801065e6:	e9 bf f2 ff ff       	jmp    801058aa <alltraps>
...
801065ed:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
801065f2:	e9 b3 f2 ff ff       	jmp    801058aa <alltraps>
...
801065f9:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
801065fe:	e9 a7 f2 ff ff       	jmp    801058aa <alltraps>
...
80106605:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010660a:	e9 9b f2 ff ff       	jmp    801058aa <alltraps>
...
80106611:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106616:	e9 8f f2 ff ff       	jmp    801058aa <alltraps>
...
8010661d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106622:	e9 83 f2 ff ff       	jmp    801058aa <alltraps>
...
80106629:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010662e:	e9 77 f2 ff ff       	jmp    801058aa <alltraps>
...
80106635:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010663a:	e9 6b f2 ff ff       	jmp    801058aa <alltraps>
...
80106641:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106646:	e9 5f f2 ff ff       	jmp    801058aa <alltraps>
...
8010664d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
80106652:	e9 53 f2 ff ff       	jmp    801058aa <alltraps>
...
80106659:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
8010665e:	e9 47 f2 ff ff       	jmp    801058aa <alltraps>
...
80106665:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
8010666a:	e9 3b f2 ff ff       	jmp    801058aa <alltraps>
...
80106671:	68 de 00 00 00       	push   $0xde
  jmp alltraps
80106676:	e9 2f f2 ff ff       	jmp    801058aa <alltraps>
...
8010667d:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
80106682:	e9 23 f2 ff ff       	jmp    801058aa <alltraps>
...
80106689:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
8010668e:	e9 17 f2 ff ff       	jmp    801058aa <alltraps>
...
80106695:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
8010669a:	e9 0b f2 ff ff       	jmp    801058aa <alltraps>
...
801066a1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066a6:	e9 ff f1 ff ff       	jmp    801058aa <alltraps>
...
801066ad:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
801066b2:	e9 f3 f1 ff ff       	jmp    801058aa <alltraps>
...
801066b9:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
801066be:	e9 e7 f1 ff ff       	jmp    801058aa <alltraps>
...
801066c5:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
801066ca:	e9 db f1 ff ff       	jmp    801058aa <alltraps>
...
801066d1:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
801066d6:	e9 cf f1 ff ff       	jmp    801058aa <alltraps>
...
801066dd:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
801066e2:	e9 c3 f1 ff ff       	jmp    801058aa <alltraps>
...
801066e9:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
801066ee:	e9 b7 f1 ff ff       	jmp    801058aa <alltraps>
...
801066f5:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
801066fa:	e9 ab f1 ff ff       	jmp    801058aa <alltraps>
...
80106701:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106706:	e9 9f f1 ff ff       	jmp    801058aa <alltraps>
...
8010670d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106712:	e9 93 f1 ff ff       	jmp    801058aa <alltraps>
...
80106719:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010671e:	e9 87 f1 ff ff       	jmp    801058aa <alltraps>
...
80106725:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010672a:	e9 7b f1 ff ff       	jmp    801058aa <alltraps>
...
80106731:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106736:	e9 6f f1 ff ff       	jmp    801058aa <alltraps>
...
8010673d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106742:	e9 63 f1 ff ff       	jmp    801058aa <alltraps>
...
80106749:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010674e:	e9 57 f1 ff ff       	jmp    801058aa <alltraps>
...
80106755:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
8010675a:	e9 4b f1 ff ff       	jmp    801058aa <alltraps>
...
80106761:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
80106766:	e9 3f f1 ff ff       	jmp    801058aa <alltraps>
...
8010676d:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
80106772:	e9 33 f1 ff ff       	jmp    801058aa <alltraps>
...
80106779:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
8010677e:	e9 27 f1 ff ff       	jmp    801058aa <alltraps>
...
80106785:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
8010678a:	e9 1b f1 ff ff       	jmp    801058aa <alltraps>
...
80106791:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
80106796:	e9 0f f1 ff ff       	jmp    801058aa <alltraps>
...
8010679d:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067a2:	e9 03 f1 ff ff       	jmp    801058aa <alltraps>
...
801067a9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067ae:	e9 f7 f0 ff ff       	jmp    801058aa <alltraps>
...
801067b5:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
801067ba:	e9 eb f0 ff ff       	jmp    801058aa <alltraps>
...
801067c1:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
801067c6:	e9 df f0 ff ff       	jmp    801058aa <alltraps>
...
801067cd:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
801067d2:	e9 d3 f0 ff ff       	jmp    801058aa <alltraps>
...
801067d9:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
801067de:	e9 c7 f0 ff ff       	jmp    801058aa <alltraps>
...
801067e5:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
801067ea:	e9 bb f0 ff ff       	jmp    801058aa <alltraps>
...
801067f1:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
801067f6:	e9 af f0 ff ff       	jmp    801058aa <alltraps>
...
801067fd:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106802:	e9 a3 f0 ff ff       	jmp    801058aa <alltraps>
...
80106825:	89 4d e0             	mov    %ecx,-0x20(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106828:	39 d3                	cmp    %edx,%ebx
8010682a:	73 49                	jae    80106875 <deallocuvm.part.0+0x65>
8010682c:	89 c7                	mov    %eax,%edi
8010682e:	eb 0c                	jmp    8010683c <deallocuvm.part.0+0x2c>
    pte = walkpgdir(pgdir, (char*)a, 0);
    if(!pte)
      a = PGADDR(PDX(a) + 1, 0, 0) - PGSIZE;
80106830:	83 c0 01             	add    $0x1,%eax
80106833:	c1 e0 16             	shl    $0x16,%eax
80106836:	89 c3                	mov    %eax,%ebx
  for(; a  < oldsz; a += PGSIZE){
80106838:	39 da                	cmp    %ebx,%edx
8010683a:	76 39                	jbe    80106875 <deallocuvm.part.0+0x65>
  pde = &pgdir[PDX(va)];
8010683c:	89 d8                	mov    %ebx,%eax
8010683e:	c1 e8 16             	shr    $0x16,%eax
  if(*pde & PTE_P){
80106841:	8b 0c 87             	mov    (%edi,%eax,4),%ecx
80106844:	f6 c1 01             	test   $0x1,%cl
80106847:	74 e7                	je     80106830 <deallocuvm.part.0+0x20>
  return &pgtab[PTX(va)];
80106849:	89 de                	mov    %ebx,%esi
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
8010684b:	81 e1 00 f0 ff ff    	and    $0xfffff000,%ecx
  return &pgtab[PTX(va)];
80106851:	c1 ee 0a             	shr    $0xa,%esi
80106854:	81 e6 fc 0f 00 00    	and    $0xffc,%esi
8010685a:	8d b4 31 00 00 00 80 	lea    -0x80000000(%ecx,%esi,1),%esi
    if(!pte)
80106861:	85 f6                	test   %esi,%esi
80106863:	74 cb                	je     80106830 <deallocuvm.part.0+0x20>
    else if((*pte & PTE_P) != 0){
80106865:	8b 06                	mov    (%esi),%eax
80106867:	a8 01                	test   $0x1,%al
80106869:	75 15                	jne    80106880 <deallocuvm.part.0+0x70>
  for(; a  < oldsz; a += PGSIZE){
8010686b:	81 c3 00 10 00 00    	add    $0x1000,%ebx
80106871:	39 da                	cmp    %ebx,%edx
80106873:	77 c7                	ja     8010683c <deallocuvm.part.0+0x2c>
      kfree(v);
      *pte = 0;
    }
  }
...
8010687f:	c3                   	ret    
      if(pa == 0)
80106880:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80106885:	74 25                	je     801068ac <deallocuvm.part.0+0x9c>
      kfree(v);
80106887:	83 ec 0c             	sub    $0xc,%esp
      char *v = P2V(pa);
8010688a:	05 00 00 00 80       	add    $0x80000000,%eax
8010688f:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  for(; a  < oldsz; a += PGSIZE){
80106892:	81 c3 00 10 00 00    	add    $0x1000,%ebx
      kfree(v);
80106898:	50                   	push   %eax
80106899:	e8 22 bc ff ff       	call   801024c0 <kfree>
      *pte = 0;
8010689e:	c7 06 00 00 00 00    	movl   $0x0,(%esi)
  for(; a  < oldsz; a += PGSIZE){
801068a4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801068a7:	83 c4 10             	add    $0x10,%esp
801068aa:	eb 8c                	jmp    80106838 <deallocuvm.part.0+0x28>
        panic("kfree");
801068ac:	83 ec 0c             	sub    $0xc,%esp
801068af:	68 66 74 10 80       	push   $0x80107466
801068b4:	e8 c7 9a ff ff       	call   80100380 <panic>
...
801068e5:	89 45 e0             	mov    %eax,-0x20(%ebp)
801068e8:	eb 3d                	jmp    80106927 <mappages+0x67>
...
8010691a:	89 30                	mov    %esi,(%eax)
    if(a == last)
8010691c:	3b 5d dc             	cmp    -0x24(%ebp),%ebx
8010691f:	74 6f                	je     80106990 <mappages+0xd0>
    a += PGSIZE;
80106921:	81 c3 00 10 00 00    	add    $0x1000,%ebx
  for(;;){
80106927:	8b 45 e0             	mov    -0x20(%ebp),%eax
  pde = &pgdir[PDX(va)];
8010692a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010692d:	8d 34 18             	lea    (%eax,%ebx,1),%esi
80106930:	89 d8                	mov    %ebx,%eax
80106932:	c1 e8 16             	shr    $0x16,%eax
80106935:	8d 3c 81             	lea    (%ecx,%eax,4),%edi
  if(*pde & PTE_P){
80106938:	8b 07                	mov    (%edi),%eax
8010693a:	a8 01                	test   $0x1,%al
8010693c:	75 b2                	jne    801068f0 <mappages+0x30>
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
8010693e:	e8 3d bd ff ff       	call   80102680 <kalloc>
80106943:	85 c0                	test   %eax,%eax
80106945:	74 39                	je     80106980 <mappages+0xc0>
    memset(pgtab, 0, PGSIZE);
80106947:	83 ec 04             	sub    $0x4,%esp
8010694a:	89 45 d8             	mov    %eax,-0x28(%ebp)
8010694d:	68 00 10 00 00       	push   $0x1000
80106952:	6a 00                	push   $0x0
80106954:	50                   	push   %eax
80106955:	e8 06 dd ff ff       	call   80104660 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
8010695a:	8b 55 d8             	mov    -0x28(%ebp),%edx
  return &pgtab[PTX(va)];
8010695d:	83 c4 10             	add    $0x10,%esp
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
80106960:	8d 82 00 00 00 80    	lea    -0x80000000(%edx),%eax
80106966:	83 c8 07             	or     $0x7,%eax
80106969:	89 07                	mov    %eax,(%edi)
  return &pgtab[PTX(va)];
8010696b:	89 d8                	mov    %ebx,%eax
8010696d:	c1 e8 0a             	shr    $0xa,%eax
80106970:	25 fc 0f 00 00       	and    $0xffc,%eax
80106975:	01 d0                	add    %edx,%eax
80106977:	eb 92                	jmp    8010690b <mappages+0x4b>
...
8010699d:	68 b0 7a 10 80       	push   $0x80107ab0
...
801069b3:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
801069b6:	e8 95 cf ff ff       	call   80103950 <cpuid>
  pd[0] = size-1;
...
80106a7f:	e8 6c ce ff ff       	call   801038f0 <mycpu>
80106a84:	89 c3                	mov    %eax,%ebx
80106a86:	e8 65 ce ff ff       	call   801038f0 <mycpu>
...
80106a98:	e8 53 ce ff ff       	call   801038f0 <mycpu>
...
80106aff:	e8 ec cd ff ff       	call   801038f0 <mycpu>
80106b04:	89 58 0c             	mov    %ebx,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106b07:	e8 e4 cd ff ff       	call   801038f0 <mycpu>
...
80106b6f:	8b 7d 08             	mov    0x8(%ebp),%edi
80106b72:	89 45 e4             	mov    %eax,-0x1c(%ebp)
  if(sz >= PGSIZE)
80106b75:	81 fe ff 0f 00 00    	cmp    $0xfff,%esi
80106b7b:	77 4b                	ja     80106bc8 <inituvm+0x68>
  mem = kalloc();
80106b7d:	e8 fe ba ff ff       	call   80102680 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b8f:	e8 cc da ff ff       	call   80104660 <memset>
...
80106ba8:	e8 13 fd ff ff       	call   801068c0 <mappages>
  memmove(mem, init, sz);
80106bad:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106bb0:	89 75 10             	mov    %esi,0x10(%ebp)
80106bb3:	83 c4 10             	add    $0x10,%esp
80106bb6:	89 5d 08             	mov    %ebx,0x8(%ebp)
80106bb9:	89 45 0c             	mov    %eax,0xc(%ebp)
}
80106bbc:	8d 65 f4             	lea    -0xc(%ebp),%esp
80106bbf:	5b                   	pop    %ebx
80106bc0:	5e                   	pop    %esi
80106bc1:	5f                   	pop    %edi
80106bc2:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106bc3:	e9 38 db ff ff       	jmp    80104700 <memmove>
    panic("inituvm: more than a page");
80106bc8:	83 ec 0c             	sub    $0xc,%esp
80106bcb:	68 f5 7a 10 80       	push   $0x80107af5
80106bd0:	e8 ab 97 ff ff       	call   80100380 <panic>
80106bd5:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
...
80106bec:	8b 75 18             	mov    0x18(%ebp),%esi
  if((uint) addr % PGSIZE != 0)
80106bef:	a9 ff 0f 00 00       	test   $0xfff,%eax
80106bf4:	0f 85 bb 00 00 00    	jne    80106cb5 <loaduvm+0xd5>
  for(i = 0; i < sz; i += PGSIZE){
80106bfa:	01 f0                	add    %esi,%eax
80106bfc:	89 f3                	mov    %esi,%ebx
80106bfe:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if(readi(ip, P2V(pa), offset+i, n) != n)
80106c01:	8b 45 14             	mov    0x14(%ebp),%eax
80106c04:	01 f0                	add    %esi,%eax
80106c06:	89 45 e0             	mov    %eax,-0x20(%ebp)
  for(i = 0; i < sz; i += PGSIZE){
80106c09:	85 f6                	test   %esi,%esi
80106c0b:	0f 84 87 00 00 00    	je     80106c98 <loaduvm+0xb8>
80106c11:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  pde = &pgdir[PDX(va)];
80106c18:	8b 45 e4             	mov    -0x1c(%ebp),%eax
  if(*pde & PTE_P){
80106c1b:	8b 4d 08             	mov    0x8(%ebp),%ecx
80106c1e:	29 d8                	sub    %ebx,%eax
  pde = &pgdir[PDX(va)];
80106c20:	89 c2                	mov    %eax,%edx
80106c22:	c1 ea 16             	shr    $0x16,%edx
  if(*pde & PTE_P){
80106c25:	8b 14 91             	mov    (%ecx,%edx,4),%edx
80106c28:	f6 c2 01             	test   $0x1,%dl
80106c2b:	75 13                	jne    80106c40 <loaduvm+0x60>
      panic("loaduvm: address should exist");
80106c2d:	83 ec 0c             	sub    $0xc,%esp
80106c30:	68 0f 7b 10 80       	push   $0x80107b0f
80106c35:	e8 46 97 ff ff       	call   80100380 <panic>
80106c3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
  return &pgtab[PTX(va)];
80106c40:	c1 e8 0a             	shr    $0xa,%eax
    pgtab = (pte_t*)P2V(PTE_ADDR(*pde));
80106c43:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
  return &pgtab[PTX(va)];
80106c49:	25 fc 0f 00 00       	and    $0xffc,%eax
80106c4e:	8d 84 02 00 00 00 80 	lea    -0x80000000(%edx,%eax,1),%eax
    if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
80106c55:	85 c0                	test   %eax,%eax
80106c57:	74 d4                	je     80106c2d <loaduvm+0x4d>
    pa = PTE_ADDR(*pte);
...
80106c7b:	ff 75 10             	push   0x10(%ebp)
80106c7e:	e8 0d ae ff ff       	call   80101a90 <readi>
80106c83:	83 c4 10             	add    $0x10,%esp
80106c86:	39 f8                	cmp    %edi,%eax
80106c88:	75 1e                	jne    80106ca8 <loaduvm+0xc8>
  for(i = 0; i < sz; i += PGSIZE){
80106c8a:	81 eb 00 10 00 00    	sub    $0x1000,%ebx
80106c90:	89 f0                	mov    %esi,%eax
80106c92:	29 d8                	sub    %ebx,%eax
80106c94:	39 c6                	cmp    %eax,%esi
80106c96:	77 80                	ja     80106c18 <loaduvm+0x38>
}
...
80106cb8:	68 b0 7b 10 80       	push   $0x80107bb0
80106cbd:	e8 be 96 ff ff       	call   80100380 <panic>
...
80106cd6:	83 ec 1c             	sub    $0x1c,%esp
  if(newsz >= KERNBASE)
80106cd9:	8b 45 10             	mov    0x10(%ebp),%eax
{
80106cdc:	8b 7d 08             	mov    0x8(%ebp),%edi
  if(newsz >= KERNBASE)
80106cdf:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106ce2:	85 c0                	test   %eax,%eax
80106ce4:	0f 88 b6 00 00 00    	js     80106da0 <allocuvm+0xd0>
  if(newsz < oldsz)
80106cea:	3b 45 0c             	cmp    0xc(%ebp),%eax
    return oldsz;
80106ced:	8b 45 0c             	mov    0xc(%ebp),%eax
  if(newsz < oldsz)
80106cf0:	0f 82 9a 00 00 00    	jb     80106d90 <allocuvm+0xc0>
  a = PGROUNDUP(oldsz);
80106cf6:	8d b0 ff 0f 00 00    	lea    0xfff(%eax),%esi
80106cfc:	81 e6 00 f0 ff ff    	and    $0xfffff000,%esi
  for(; a < newsz; a += PGSIZE){
80106d02:	39 75 10             	cmp    %esi,0x10(%ebp)
80106d05:	77 44                	ja     80106d4b <allocuvm+0x7b>
80106d07:	e9 87 00 00 00       	jmp    80106d93 <allocuvm+0xc3>
...
80106d1b:	e8 40 d9 ff ff       	call   80104660 <memset>
...
80106d34:	e8 87 fb ff ff       	call   801068c0 <mappages>
...
80106d49:	76 48                	jbe    80106d93 <allocuvm+0xc3>
    mem = kalloc();
80106d4b:	e8 30 b9 ff ff       	call   80102680 <kalloc>
...
80106d59:	68 2d 7b 10 80       	push   $0x80107b2d
80106d5e:	e8 3d 99 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106d75:	e8 96 fa ff ff       	call   80106810 <deallocuvm.part.0>
      return 0;
...
80106dbb:	68 45 7b 10 80       	push   $0x80107b45
80106dc0:	e8 db 98 ff ff       	call   801006a0 <cprintf>
  if(newsz >= oldsz)
...
80106dd7:	e8 34 fa ff ff       	call   80106810 <deallocuvm.part.0>
      kfree(mem);
80106ddc:	83 ec 0c             	sub    $0xc,%esp
80106ddf:	53                   	push   %ebx
80106de0:	e8 db b6 ff ff       	call   801024c0 <kfree>
      return 0;
...
80106e10:	5d                   	pop    %ebp
80106e11:	e9 fa f9 ff ff       	jmp    80106810 <deallocuvm.part.0>
...
80106e4b:	e8 c0 f9 ff ff       	call   80106810 <deallocuvm.part.0>
...
80106e7e:	e8 3d b6 ff ff       	call   801024c0 <kfree>
...
80106e93:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e94:	e9 27 b6 ff ff       	jmp    801024c0 <kfree>
    panic("freevm: no pgdir");
80106e99:	83 ec 0c             	sub    $0xc,%esp
80106e9c:	68 61 7b 10 80       	push   $0x80107b61
...
80106eb5:	e8 c6 b7 ff ff       	call   80102680 <kalloc>
80106eba:	89 c6                	mov    %eax,%esi
...
80106ed0:	e8 8b d7 ff ff       	call   80104660 <memset>
...
80106ee1:	ff 73 0c             	push   0xc(%ebx)
80106ee4:	8b 13                	mov    (%ebx),%edx
80106ee6:	50                   	push   %eax
80106ee7:	29 c1                	sub    %eax,%ecx
80106ee9:	89 f0                	mov    %esi,%eax
80106eeb:	e8 d0 f9 ff ff       	call   801068c0 <mappages>
...
80106f6c:	68 72 7b 10 80       	push   $0x80107b72
...
80106fb3:	0f 84 bd 00 00 00    	je     80107076 <copyuvm+0xd6>
    return 0;
  for(i = 0; i < sz; i += PGSIZE){
...
80106fe2:	68 7c 7b 10 80       	push   $0x80107b7c
...
80107040:	e8 bb d6 ff ff       	call   80104700 <memmove>
...
8010705b:	e8 60 f8 ff ff       	call   801068c0 <mappages>
...
80107070:	0f 87 5a ff ff ff    	ja     80106fd0 <copyuvm+0x30>
  return d;
...
8010708c:	e8 2f b4 ff ff       	call   801024c0 <kfree>
      goto bad;
...
8010709a:	e8 91 fd ff ff       	call   80106e30 <freevm>
  return 0;
8010709f:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
...
801070b7:	68 96 7b 10 80       	push   $0x80107b96
...
80107170:	e8 8b d5 ff ff       	call   80104700 <memmove>
    len -= n;
    buf += n;
