...
{
  15:	81 ec 0c 02 00 00    	sub    $0x20c,%esp
  int a = getlastcat(swag);
  1b:	53                   	push   %ebx
  1c:	e8 32 03 00 00       	call   353 <getlastcat>
  if(a)
  21:	83 c4 10             	add    $0x10,%esp
  24:	85 c0                	test   %eax,%eax
  26:	74 1b                	je     43 <main+0x43>
    {
      printf(1, "XV6_TEST_OUTPUT -1");
  28:	83 ec 08             	sub    $0x8,%esp
  2b:	68 38 07 00 00       	push   $0x738
  30:	6a 01                	push   $0x1
  ...
  4c:	e8 bf 03 00 00       	call   410 <printf>
      exit();
  51:	e8 5d 02 00 00       	call   2b3 <exit>
  56:	66 90                	xchg   %ax,%ax
  58:	66 90                	xchg   %ax,%ax
  5a:	66 90                	xchg   %ax,%ax
  5c:	66 90                	xchg   %ax,%ax
 ...
 36c:	89 d1                	mov    %edx,%ecx
{
 ...
 399:	0f b6 92 d8 07 00 00 	movzbl 0x7d8(%edx),%edx
 ...
 419:	8b 5d 0c             	mov    0xc(%ebp),%ebx
{
 ...
 489:	ff 24 85 80 07 00 00 	jmp    *0x780(,%eax,4)
        putc(fd, c);
      }
      state = 0;
    }
 ...
 597:	90                   	nop
          s = "(null)";
 598:	ba 76 07 00 00       	mov    $0x776,%edx
        while(*s != 0){
...
free(void *ap)
{
 ...
 5b1:	a1 94 0a 00 00       	mov    0xa94,%eax
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	89 15 94 0a 00 00    	mov    %edx,0xa94
}
 5f8:	5e                   	pop    %esi
 5f9:	5f                   	pop    %edi
 5fa:	5d                   	pop    %ebp
 ...
 629:	03 43 fc             	add    -0x4(%ebx),%eax
  freep = p;
 62c:	89 15 94 0a 00 00    	mov    %edx,0xa94
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 3d 94 0a 00 00    	mov    0xa94,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68f:	73 4f                	jae    6e0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	8b 3d 94 0a 00 00    	mov    0xa94,%edi
 ...
 6ba:	e8 f1 fe ff ff       	call   5b0 <free>
  return freep;
 6bf:	8b 15 94 0a 00 00    	mov    0xa94,%edx
 ...
 6ec:	89 70 04             	mov    %esi,0x4(%eax)
      freep = prevp;
 6ef:	89 15 94 0a 00 00    	mov    %edx,0xa94
}
 ...
 6ff:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf 98 0a 00 00       	mov    $0xa98,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 fa                	mov    %edi,%edx
    base.s.size = 0;
 71b:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 722:	00 00 00 
    if(p->s.size >= nunits){
