...
int main(int argc, char* argv[])
{
  ...
  19:	e8 8f 02 00 00       	call   2ad <exit>

  int x = 0;
  1e:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
  for(int i = 1; i < atoi(argv[1]); i++)
  25:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
  2c:	eb 0a                	jmp    38 <main+0x38>
    {
      x += i;
  2e:	8b 45 f0             	mov    -0x10(%ebp),%eax
  31:	01 45 f4             	add    %eax,-0xc(%ebp)
  for(int i = 1; i < atoi(argv[1]); i++)
  34:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
